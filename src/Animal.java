...
public class Animal
{
    ...
    public boolean equals(Object other)
    {
        ...
        String colorCompare1 = otherAni.getColor();
        String nameCompare1 = otherAni.getName();
        double weightCompare1 = otherAni.getWeight();
        double heightCompare1 = otherAni.getHeight();
        
        String colorCompare2 = this.getColor();
        String nameCompare2 = this.getName();
        double weightCompare2 = this.getWeight();
        double heightCompare2 = this.getHeight();
        
        if((colorCompare1.equals(colorCompare2)) && (nameCompare1.equals(nameCompare2)) && (weightCompare1 == weightCompare2) && (heightCompare1 == heightCompare2)) {
        	return true;
        }
        else {
        	return false;
